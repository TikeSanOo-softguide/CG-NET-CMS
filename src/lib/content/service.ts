  ...
  services: [
    ...
    },
    {
      ...
      features: [
        ...
        { key: 'addonFeature1', labelKey: 'services.cgNetAddon.features.feature1', icon: Wifi },
        { key: 'addonFeature2', labelKey: 'services.cgNetAddon.features.feature2', icon: Settings },
      ],
    },
  ],
}
